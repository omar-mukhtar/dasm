...
class CFileNameDialog : public CEikDialog
{
...
private:
	...
	CFileNameDialog(TDesC** aFileName, TMediaFileTypes& aFileType);
...
class CBundleSendingOptionsDialog : public CEikDialog
{

public:
	
	static TBool RunDlgLD(TUint32* aAABundleTxOptions, TUint8* aSRRFlags, TUint32* aLifeTime);
	
private:

	CBundleSendingOptionsDialog(TUint32* aAABundleTxOptions, TUint8* aSRRFlags, TUint32* aLifeTime);
