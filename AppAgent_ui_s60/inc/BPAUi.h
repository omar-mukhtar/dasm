...
/*!
  ...
  @discussion An instance of class CBPAUi is the UserInterface part of the
  AVKON application framework for the BTPointToPoint example application
*/

class CBPAUi : public CAknAppUi
{
